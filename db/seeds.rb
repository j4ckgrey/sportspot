...
clubs_names.each_with_index do |clubname, index|
  ...
  club.user = user
  club.status = true
  club.photo.attach(io: photos[index], filename: "anything.jpeg", content_type: "image/jpeg")
...
venue1.photo.attach(io: martialarts, filename: "anything.jpeg", content_type: "image/jpeg")
vennu1.save
venue2 = Venue.create(name: "Boulderplanet", category: "Bouldering", description: description.sample, price: 15.99, club: clubs[2])
venue2.photo.attach(io: bouldering, filename: "anything.jpeg", content_type: "image/jpeg")
vennu2.save
venue3 = Venue.create(name: "Kletterfabrik Köln", category: "Bouldering", description: description.sample, price: 70.99, club: clubs[3])
venue3.photo.attach(io: bouldering, filename: "anything.jpeg", content_type: "image/jpeg")
vennu3.save
...
scjenusvenues.each do |venue|
  ...
  venue_name.photo.attach(io: photos.rand, filename: "anything.jpeg", content_type: "image/jpeg")
...
venue9.photo.attach(io: volleyball, filename: "anything.jpeg", content_type: "image/jpeg")
